...
@section('content')
    <div class="container">
        <section class="about-section mb-5 text-center">
            ...
            <p class="lead">
                VR-Shop — ваш надежный проводник в мир виртуальной реальности. Мы предлагаем лучшие VR-шлемы, аксессуары и
                компьютеры для полного погружения в цифровую реальность.
            </p>
            <p class="tagline">
                Откройте новые миры с VR-Shop — ваш путь к безграничным возможностям виртуальной реальности!
            </p>
        </section>
        <div id="productCarousel" class="carousel slide mb-5 my-carousel" data-bs-ride="carousel"
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                <a href="https://www.meta.com/quest/quest-3s/" class="news-card-link">
                                    <div class="news-card text-center">
                                        ...
                                        <p>Meta представила Quest 3S — доступный VR-шлем с улучшенными камерами и смешанной
                                            реальностью, идеальный для игр и работы.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                <a href="https://www.apple.com/newsroom/" class="news-card-link">
                                    <div class="news-card text-center">
                                        ...
                                        <p>Apple работает над Vision Pro 2, обещающим ещё более чёткое изображение и новые
                                            функции для работы с iPadOS.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                <a href="https://godotengine.org/article/godot-vision-pro-support" class="news-card-link">
                                    <div class="news-card text-center">
                                        ...
                                        <p>Apple открыла исходный код для Godot, позволяя разработчикам создавать VR-игры
                                            для Vision Pro.</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                <a href="https://blogs.nvidia.com/blog/geforce-now-vr-support/" class="news-card-link">
                                    <div class="news-card text-center">
                                        ...
                                        <p>NVIDIA добавила поддержку GeForce NOW для Quest 3S и Vision Pro, открывая доступ
                                            к тысячам игр через облако.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                <a href="https://www.samsung.com/us/newsroom/" class="news-card-link">
                                    <div class="news-card text-center">
                                        ...
                                        <p>Samsung анонсировала VR-шлем на Android XR, который составит конкуренцию Apple
                                            Vision Pro.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                <a href="https://www.sony.com/en-us/playstation/psvr2/" class="news-card-link">
                                    <div class="news-card text-center">
                                        ...
                                        <p>Apple и Sony работают над поддержкой контроллеров PSVR 2 для Vision Pro, улучшая
                                            игровой опыт.</p>
                                    </div>
                                </a>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-3 order-lg-2">
                <button class="btn btn-success d-lg-none mb-3" type="button" data-bs-toggle="collapse"
                    ...
                    <form method="GET" action="{{ route('home') }}">
                        ...
                        <div class="form-group mb-3 position-relative">
                            ...
                            <select name="category_id" id="category_id" class="form-control">
                                <option value="" {{ !isset($filters['category_id']) ? 'selected' : '' }}>Все
                                    категории</option>
                        ...
                        @forelse ($products as $product)
                            <div class="col-md-4 col-sm-6 mb-4 d-flex">
                                <div class="product-card flex-grow-1 d-flex flex-column">
                                    ...
                                    <div class="item-status mt-2"><i class="{{ $product->status->icon }}"></i>
                                        {{ $product->status->title }}</div>
                                </div>
                            </div>
                        @empty
