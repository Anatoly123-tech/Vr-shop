    ...
    <div class="container">
        ...
        <form action="{{ route('admin.table.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" id="price" name="price" class="form-control" step="1" value="{{ old('price') }}" required>
                @error('price')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" id="old_price" name="old_price" class="form-control" step="1" value="{{ old('old_price') }}">
                @error('old_price')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
